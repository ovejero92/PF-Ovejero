...
import { authUser, authLoading, authError } from '../../store/auth/auth.selectors';
...
export class AuthComponent implements OnInit, OnDestroy {
  ...
  get emailControl() { return this.userRegister.get('email'); }
  get nameControl() { return this.userRegister.get('firstName'); }
  get phoneControl() { return this.userRegister.get('phone'); }
  get contrasenaControl() { return this.userRegister.get('contra'); }
  ...
  constructor(
    ...
    this.authError$ = this.store.select(authError);
  }
  ...
  register(): void {
    ...
    const { firstName, phone, email, contra } = this.userRegister.getRawValue();
